import type { NativeStackNavigationOptions as RNNativeStackNavigationOptions } from "@react-navigation/native-stack"
import type { SearchBarProps } from "@react-navigation/native-stack/lib/typescript/src/types"

type NativeStackNavigationOptions = RNNativeStackNavigationOptions
...
type LargeTitleSearchBarRef = Omit<SearchBarProps, 'blur' | 'toggleCancelButton'>;
