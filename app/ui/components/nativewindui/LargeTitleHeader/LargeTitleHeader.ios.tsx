...
import { useScreen } from "@/app/ui/components/Screen"
...
export function LargeTitleHeader(props: LargeTitleHeaderProps) {
  ...
  React.useLayoutEffect(() => {
    navigation.setOptions(
      propsToScreenOptions(
        {
          ...props,
          iosBlurEffect: "none",
          backgroundColor: props.searchBar ? colors.headerBackground : colors.background,
        },
        props.searchBar ? colors.headerBackground : colors.background,
        setIsFocused,
      ),
    )
  }, [navigation, props, colors.background])
