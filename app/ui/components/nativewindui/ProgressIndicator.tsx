  ...
  (
    ...
    return (
      <View
        ...
        className={cn("relative h-[5px] w-full overflow-hidden rounded-full", className)}
        {...props}
      >
        <View className="bg-base-content absolute bottom-0 left-0 right-0 top-0 opacity-20" />
